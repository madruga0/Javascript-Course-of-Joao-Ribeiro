...
// entidades do mundo real e definir comportamentos para esses objetos. (abstracao)
...
class Human {
  // propriedade de uma classe (variavel interna dessa classe)
  name;

  // métodos de uma classe
  talk() {
    console.log(this.name + " esta a falar");
  }

  jump() {
    console.log(this.name + " esta a saltar");
  }
  walk() {
    console.log(this.name + " esta a andar");
  }
}
