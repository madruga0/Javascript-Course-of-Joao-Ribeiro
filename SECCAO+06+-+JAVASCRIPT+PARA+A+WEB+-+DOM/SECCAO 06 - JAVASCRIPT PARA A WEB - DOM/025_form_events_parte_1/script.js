...
const textName = document.querySelector('input#name')
const textEmail = document.querySelector('input#email')
...
form.addEventListener('submit', (event) => {    
    ...
    // podemos fazer uma logica para conferir se todos os campos estao preenchidos

    // se falhar a validacao
    // if() {
