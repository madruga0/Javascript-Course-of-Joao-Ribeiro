...
p1.innerHTML = p1.innerHTML + ' <b>Texto Adicionado</b>';

// vamos alterar a cor da palavra "amet"
p1.innerHTML = p1.innerHTML.replace('amet', '<span class="text-green-700">amet</span>');
...
div1.innerHTML = div1.innerHTML.replace('Text', '<span class="text-red-500">TEST</span>');