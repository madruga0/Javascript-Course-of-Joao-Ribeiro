...
console.log(`Total classes inputNome: ${inputNome.classList.length}`)
console.log('Classes de CSS no inputNome: ' + inputNome.classList.value);
let inputNomeArr = Array.from(inputNome.classList)
// console.log(inputNomeArr)

for(let i = 0; i <= inputNomeArr.length; i++) {
    console.log(inputNomeArr[i]);
}


let inputNomeValue = Array.from(inputNome.value)
...
function visivel(){
    ...
    // o que eu quero que seja alternado? 
}